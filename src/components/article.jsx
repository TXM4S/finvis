...
const Article = (props) => {
  ...
  const positive = <div className="badge badge-secondary">pos</div>;
  const neutral = <div className="badge badge-primary">neu</div>;
  const negative = <div className="badge badge-accent">neg</div>;
